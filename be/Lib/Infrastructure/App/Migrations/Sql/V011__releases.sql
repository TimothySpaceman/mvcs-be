...
BEGIN
    ...
    VALUES ('20260329135232_init', '10.0.8');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260330123419_auth_basics') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260330123419_auth_basics', '10.0.8');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260330222608_sessions_revoke') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260330222608_sessions_revoke', '10.0.8');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260331095516_sessions_to_users_fix') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260331095516_sessions_to_users_fix', '10.0.8');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260408160729_storages') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260408160729_storages', '10.0.8');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260416183338_projects') THEN
    CREATE TABLE projects (
        ...
        CONSTRAINT "FK_projects_storages_StorageId" FOREIGN KEY ("StorageId") REFERENCES storages ("Id") ON DELETE RESTRICT,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260416183338_projects') THEN
    CREATE INDEX "IX_projects_StorageId" ON projects ("StorageId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260416183338_projects') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260416183338_projects', '10.0.8');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260417174310_project_access') THEN
    ALTER TABLE storage_access ALTER COLUMN "AccessType" TYPE text;
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE project_access (
        ...
        "CreatedAt" timestamp with time zone NOT NULL,
        "UpdatedAt" timestamp with time zone NOT NULL,
        CONSTRAINT "PK_project_access" PRIMARY KEY ("ProjectId", "UserId"),
        CONSTRAINT "FK_project_access_projects_ProjectId" FOREIGN KEY ("ProjectId") REFERENCES projects ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260417174310_project_access') THEN
    CREATE INDEX "IX_project_access_UserId" ON project_access ("UserId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260417174310_project_access') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260417174310_project_access', '10.0.8');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260605141132_default_refs') THEN
    ALTER TABLE projects ADD "DefaultRefName" character varying(255);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260605141132_default_refs') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260605141132_default_refs', '10.0.8');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260612203706_tasks_basics') THEN
    CREATE TABLE project_tasks (
        ...
        CONSTRAINT "FK_project_tasks_users_AuthorId" FOREIGN KEY ("AuthorId") REFERENCES users ("Id") ON DELETE RESTRICT
    );
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE task_assignments (
        ...
        "UserId" uuid NOT NULL,
        "CreatedAt" timestamp with time zone NOT NULL,
        CONSTRAINT "PK_task_assignments" PRIMARY KEY ("TaskId", "UserId"),
        CONSTRAINT "FK_task_assignments_project_tasks_TaskId" FOREIGN KEY ("TaskId") REFERENCES project_tasks ("Id") ON DELETE CASCADE,
        CONSTRAINT "FK_task_assignments_users_UserId" FOREIGN KEY ("UserId") REFERENCES users ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260612203706_tasks_basics') THEN
    CREATE INDEX "IX_project_tasks_AuthorId" ON project_tasks ("AuthorId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260612203706_tasks_basics') THEN
    CREATE INDEX "IX_project_tasks_ProjectId" ON project_tasks ("ProjectId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260612203706_tasks_basics') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260612203706_tasks_basics', '10.0.8');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260619210322_access_user_fks') THEN
    ALTER TABLE project_tasks DROP CONSTRAINT "FK_project_tasks_users_AuthorId";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260619210322_access_user_fks') THEN
    ALTER TABLE project_tasks ALTER COLUMN "AuthorId" DROP NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260619210322_access_user_fks') THEN
    ALTER TABLE project_access ADD CONSTRAINT "FK_project_access_users_UserId" FOREIGN KEY ("UserId") REFERENCES users ("Id") ON DELETE CASCADE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260619210322_access_user_fks') THEN
    ALTER TABLE project_tasks ADD CONSTRAINT "FK_project_tasks_users_AuthorId" FOREIGN KEY ("AuthorId") REFERENCES users ("Id") ON DELETE SET NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260619210322_access_user_fks') THEN
    ALTER TABLE storage_access ADD CONSTRAINT "FK_storage_access_users_UserId" FOREIGN KEY ("UserId") REFERENCES users ("Id") ON DELETE CASCADE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260619210322_access_user_fks') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260619210322_access_user_fks', '10.0.8');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260619210629_releases') THEN
    CREATE TABLE releases (
        ...
        CONSTRAINT "FK_releases_projects_ProjectId" FOREIGN KEY ("ProjectId") REFERENCES projects ("Id") ON DELETE CASCADE,
        CONSTRAINT "FK_releases_users_AuthorId" FOREIGN KEY ("AuthorId") REFERENCES users ("Id") ON DELETE SET NULL
    );
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE release_files (
        ...
        "BlobId" character varying(32) NOT NULL,
        "CreatedAt" timestamp with time zone NOT NULL,
        CONSTRAINT "PK_release_files" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_release_files_releases_ReleaseId" FOREIGN KEY ("ReleaseId") REFERENCES releases ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260619210629_releases') THEN
    CREATE INDEX "IX_release_files_ReleaseId" ON release_files ("ReleaseId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260619210629_releases') THEN
    CREATE INDEX "IX_releases_AuthorId" ON releases ("AuthorId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260619210629_releases') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260619210629_releases', '10.0.8');
    END IF;
END $EF$;
COMMIT;
